...
def generate_launch_description():
    ...
    my_nav_dir = get_package_share_directory('rosky2_nav')
    my_slam_dir = get_package_share_directory('rosky2_slam')
    my_launch_dir = os.path.join(my_nav_dir, 'launch')
    my_param_dir = os.path.join(my_nav_dir, 'param')
    my_param_file = 'rosky2_params.yaml'
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map',
        default_value=os.path.join(my_map_dir, my_map_file), # need to modified 
